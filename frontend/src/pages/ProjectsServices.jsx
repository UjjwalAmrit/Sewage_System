...
const ProjectsServices = () => {
  ...
  const getServiceIcon = (id) => {
    switch (id) {
      case 1:
        return <FaWater className="text-4xl text-blue-500" />
      case 2:
        return <FaIndustry className="text-4xl text-green-500" />
      case 3:
        return <FaRecycle className="text-4xl text-teal-500" />
      default:
        return <FaWater className="text-4xl text-blue-500" />
    }
  }
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Projects & Services</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {data?.services?.map((service) => (
                <div key={service.id} className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition-shadow">
                  <div className="flex justify-center mb-6">{getServiceIcon(service.id)}</div>
